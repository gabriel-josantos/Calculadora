  ...
  return (
    <div className={styles['calculator-container']}>
      ...
      <div className="keys-box">
        <Button className="switch-key" content="2nd" />
        <Button className="degree-key" content="deg" />
        <Button className="sin-key" content="sin" />
        <Button className="cos-key" content="cos" />
        <Button className="tan-key" content="tan" />
        <AritimeticButton
          className="exponential-key"
          value="^"
          content={
            <span>
              x<sup>y</sup>
        ...
        />
        <Button className="log-key" content="log" />
        <Button className="ln-key" content="ln" />
        <NumericButton
          className="left-parenthesis-key"
          content="("
          value="("
          onNumericKey={calculatorCtx.onNumericKey}
        />
        <NumericButton
          className="right-parenthesis-key"
          content=")"
          value=")"
          onNumericKey={calculatorCtx.onNumericKey}
        />
        <AritimeticButton
          className="square-root-key operator"
          value="sqrt"
          content="&#x221A;"
          onAritimeticKey={calculatorCtx.onAritimeticKey}
        />
        ...
        <AritimeticButton
          ...
          onAritimeticKey={calculatorCtx.onAritimeticKey}
        />
        <Button className="factorial-key" content="x!" />
        <NumericButton
        ...
        <AritimeticButton
          ...
          onAritimeticKey={calculatorCtx.onAritimeticKey}
        />
        <Button className="pi-key" content="&#960;" value={3.1415} />
        <NumericButton
        ...
        />
        <Button className="exp-key main-key" content="e" />
        <NumericButton
